...
void GenerationSizer::initialize_alignments() {
  _space_alignment = _gen_alignment = default_gen_alignment(); // added by charlie : _space_aligmnment == 512k
  _heap_alignment = compute_heap_alignment(); // added by charlie : 2M
}
