...
AdjoiningGenerations::AdjoiningGenerations(ReservedSpace old_young_rs,
  ...
  size_t min_low_byte_size = policy->min_gen1_size(); //added by charlie: 6m
  size_t max_low_byte_size = policy->max_gen1_size(); //added by charlie: 75g
  size_t init_high_byte_size = policy->initial_gen0_size();//added by charlie: 30g
  size_t min_high_byte_size = policy->min_gen0_size();//added by charlie: 30g
  size_t max_high_byte_size = policy->max_gen0_size();//added by charlie: 30g
  ...
  // move the boundary.
  if (UseAdaptiveGCBoundary) { //added by charlie: not here
