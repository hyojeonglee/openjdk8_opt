...
bool PSScavenge::invoke_no_policy() {
  ...
  heap->increment_total_collections(); //added by charlie: calculate the gc counts
  ...
  size_t prev_used = heap->used(); //added by charlie: in nvdimm case, prev_used = 70g
...

  {
    ...
    size_policy->minor_collection_begin(); //added by charlie: timer reset
