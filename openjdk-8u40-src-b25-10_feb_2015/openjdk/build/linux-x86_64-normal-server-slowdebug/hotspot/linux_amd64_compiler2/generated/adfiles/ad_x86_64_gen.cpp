...
MachOper *State::MachOperGenerator(int opcode, Compile* C){
  ...
  case IMMU31:
    return new (C) immU31Oper(_leaf->get_int() );
  case IMMI_32:
  ...
  case IMMNKLASS:
    return new (C) immNKlassOper(_leaf->bottom_type()->is_narrowklass() );
  case IMMN0:
...
MachNode *State::MachNodeGenerator(int opcode, Compile* C){
  ...
  case loadI2L_immU31_rule: {
      loadI2L_immU31Node *node = new (C) loadI2L_immU31Node();
      return node;
    }
  case loadUI2L_rule: {
  ...
  case loadConNKlass_rule: {
      loadConNKlassNode *node = new (C) loadConNKlassNode();
      node->_opnd_array[1] = new (C) immNKlassOper(_leaf->bottom_type()->is_narrowklass() );
      return node;
    }
  case loadConF0_rule: {
  ...
  case storeNKlass_rule: {
      storeNKlassNode *node = new (C) storeNKlassNode();
      node->_bottom_type = _leaf->bottom_type();
      return node;
    }
  ...
  case storeImmNKlass_rule: {
      storeImmNKlassNode *node = new (C) storeImmNKlassNode();
      node->_bottom_type = _leaf->bottom_type();
      return node;
    }
  ...
  case countTrailingZerosI_bsf_rule: {
      countTrailingZerosI_bsfNode *node = new (C) countTrailingZerosI_bsfNode();
      return node;
    }
  ...
  case countTrailingZerosL_bsf_rule: {
      countTrailingZerosL_bsfNode *node = new (C) countTrailingZerosL_bsfNode();
      return node;
    }
  case popCountI_rule: {
  ...
  case membar_acquire_0_rule: {
      membar_acquire_0Node *node = new (C) membar_acquire_0Node();
      return node;
    }
  ...
  case membar_release_0_rule: {
      membar_release_0Node *node = new (C) membar_release_0Node();
      return node;
    }
  ...
  case encodeKlass_not_null_rule: {
      encodeKlass_not_nullNode *node = new (C) encodeKlass_not_nullNode();
      node->_bottom_type = _leaf->bottom_type();
      return node;
    }
  case decodeKlass_not_null_rule: {
      decodeKlass_not_nullNode *node = new (C) decodeKlass_not_nullNode();
      node->_bottom_type = _leaf->bottom_type();
      return node;
    }
  ...
  case andnI_rReg_rReg_mem_rule: {
      andnI_rReg_rReg_memNode *node = new (C) andnI_rReg_rReg_memNode();
      return node;
    }
  case andnI_rReg_rReg_mem_0_rule: {
      andnI_rReg_rReg_mem_0Node *node = new (C) andnI_rReg_rReg_mem_0Node();
      return node;
    }
  case andnI_rReg_rReg_rReg_rule: {
      andnI_rReg_rReg_rRegNode *node = new (C) andnI_rReg_rReg_rRegNode();
      return node;
    }
  case andnI_rReg_rReg_rReg_0_rule: {
      andnI_rReg_rReg_rReg_0Node *node = new (C) andnI_rReg_rReg_rReg_0Node();
      return node;
    }
  case blsiI_rReg_rReg_rule: {
      blsiI_rReg_rRegNode *node = new (C) blsiI_rReg_rRegNode();
      return node;
    }
  case blsiI_rReg_rReg_0_rule: {
      blsiI_rReg_rReg_0Node *node = new (C) blsiI_rReg_rReg_0Node();
      return node;
    }
  case blsiI_rReg_mem_rule: {
      blsiI_rReg_memNode *node = new (C) blsiI_rReg_memNode();
      return node;
    }
  case blsiI_rReg_mem_0_rule: {
      blsiI_rReg_mem_0Node *node = new (C) blsiI_rReg_mem_0Node();
      return node;
    }
  case blsmskI_rReg_mem_rule: {
      blsmskI_rReg_memNode *node = new (C) blsmskI_rReg_memNode();
      return node;
    }
  case blsmskI_rReg_mem_0_rule: {
      blsmskI_rReg_mem_0Node *node = new (C) blsmskI_rReg_mem_0Node();
      return node;
    }
  case blsmskI_rReg_rReg_rule: {
      blsmskI_rReg_rRegNode *node = new (C) blsmskI_rReg_rRegNode();
      return node;
    }
  case blsmskI_rReg_rReg_0_rule: {
      blsmskI_rReg_rReg_0Node *node = new (C) blsmskI_rReg_rReg_0Node();
      return node;
    }
  case blsrI_rReg_rReg_rule: {
      blsrI_rReg_rRegNode *node = new (C) blsrI_rReg_rRegNode();
      return node;
    }
  case blsrI_rReg_rReg_0_rule: {
      blsrI_rReg_rReg_0Node *node = new (C) blsrI_rReg_rReg_0Node();
      return node;
    }
  case blsrI_rReg_mem_rule: {
      blsrI_rReg_memNode *node = new (C) blsrI_rReg_memNode();
      return node;
    }
  case blsrI_rReg_mem_0_rule: {
      blsrI_rReg_mem_0Node *node = new (C) blsrI_rReg_mem_0Node();
      return node;
    }
  case orI_rReg_rule: {
  ...
  case andnL_rReg_rReg_mem_rule: {
      andnL_rReg_rReg_memNode *node = new (C) andnL_rReg_rReg_memNode();
      return node;
    }
  case andnL_rReg_rReg_mem_0_rule: {
      andnL_rReg_rReg_mem_0Node *node = new (C) andnL_rReg_rReg_mem_0Node();
      return node;
    }
  case andnL_rReg_rReg_rReg_rule: {
      andnL_rReg_rReg_rRegNode *node = new (C) andnL_rReg_rReg_rRegNode();
      return node;
    }
  case andnL_rReg_rReg_rReg_0_rule: {
      andnL_rReg_rReg_rReg_0Node *node = new (C) andnL_rReg_rReg_rReg_0Node();
      return node;
    }
  case blsiL_rReg_rReg_rule: {
      blsiL_rReg_rRegNode *node = new (C) blsiL_rReg_rRegNode();
      return node;
    }
  case blsiL_rReg_rReg_0_rule: {
      blsiL_rReg_rReg_0Node *node = new (C) blsiL_rReg_rReg_0Node();
      return node;
    }
  case blsiL_rReg_mem_rule: {
      blsiL_rReg_memNode *node = new (C) blsiL_rReg_memNode();
      return node;
    }
  case blsiL_rReg_mem_0_rule: {
      blsiL_rReg_mem_0Node *node = new (C) blsiL_rReg_mem_0Node();
      return node;
    }
  case blsmskL_rReg_mem_rule: {
      blsmskL_rReg_memNode *node = new (C) blsmskL_rReg_memNode();
      return node;
    }
  case blsmskL_rReg_mem_0_rule: {
      blsmskL_rReg_mem_0Node *node = new (C) blsmskL_rReg_mem_0Node();
      return node;
    }
  case blsmskL_rReg_rReg_rule: {
      blsmskL_rReg_rRegNode *node = new (C) blsmskL_rReg_rRegNode();
      return node;
    }
  case blsmskL_rReg_rReg_0_rule: {
      blsmskL_rReg_rReg_0Node *node = new (C) blsmskL_rReg_rReg_0Node();
      return node;
    }
  case blsrL_rReg_rReg_rule: {
      blsrL_rReg_rRegNode *node = new (C) blsrL_rReg_rRegNode();
      return node;
    }
  case blsrL_rReg_rReg_0_rule: {
      blsrL_rReg_rReg_0Node *node = new (C) blsrL_rReg_rReg_0Node();
      return node;
    }
  case blsrL_rReg_mem_rule: {
      blsrL_rReg_memNode *node = new (C) blsrL_rReg_memNode();
      return node;
    }
  case blsrL_rReg_mem_0_rule: {
      blsrL_rReg_mem_0Node *node = new (C) blsrL_rReg_mem_0Node();
      return node;
    }
  case orL_rReg_rule: {
  ...
  case and_cmpLTMask_rule: {
      and_cmpLTMaskNode *node = new (C) and_cmpLTMaskNode();
      return node;
    }
  case and_cmpLTMask_0_rule: {
      and_cmpLTMask_0Node *node = new (C) and_cmpLTMask_0Node();
      return node;
    }
  ...
  case rep_fast_stosb_rule: {
      rep_fast_stosbNode *node = new (C) rep_fast_stosbNode();
      return node;
    }
  ...
  case encode_iso_array_rule: {
      encode_iso_arrayNode *node = new (C) encode_iso_arrayNode();
      node->set_opnd_array(4, MachOperGenerator(REGD, C));
      node->set_opnd_array(5, MachOperGenerator(REGD, C));
      node->set_opnd_array(6, MachOperGenerator(REGD, C));
      node->set_opnd_array(7, MachOperGenerator(REGD, C));
      return node;
    }
  case overflowAddI_rReg_rule: {
      overflowAddI_rRegNode *node = new (C) overflowAddI_rRegNode();
      return node;
    }
  case overflowAddI_rReg_imm_rule: {
      overflowAddI_rReg_immNode *node = new (C) overflowAddI_rReg_immNode();
      return node;
    }
  case overflowAddL_rReg_rule: {
      overflowAddL_rRegNode *node = new (C) overflowAddL_rRegNode();
      return node;
    }
  case overflowAddL_rReg_imm_rule: {
      overflowAddL_rReg_immNode *node = new (C) overflowAddL_rReg_immNode();
      return node;
    }
  case overflowSubI_rReg_rule: {
      overflowSubI_rRegNode *node = new (C) overflowSubI_rRegNode();
      return node;
    }
  case overflowSubI_rReg_imm_rule: {
      overflowSubI_rReg_immNode *node = new (C) overflowSubI_rReg_immNode();
      return node;
    }
  case overflowSubL_rReg_rule: {
      overflowSubL_rRegNode *node = new (C) overflowSubL_rRegNode();
      return node;
    }
  case overflowSubL_rReg_imm_rule: {
      overflowSubL_rReg_immNode *node = new (C) overflowSubL_rReg_immNode();
      return node;
    }
  case overflowNegI_rReg_rule: {
      overflowNegI_rRegNode *node = new (C) overflowNegI_rRegNode();
      return node;
    }
  case overflowNegL_rReg_rule: {
      overflowNegL_rRegNode *node = new (C) overflowNegL_rRegNode();
      return node;
    }
  case overflowMulI_rReg_rule: {
      overflowMulI_rRegNode *node = new (C) overflowMulI_rRegNode();
      return node;
    }
  case overflowMulI_rReg_imm_rule: {
      overflowMulI_rReg_immNode *node = new (C) overflowMulI_rReg_immNode();
      node->set_opnd_array(3, MachOperGenerator(RREGI, C));
      return node;
    }
  case overflowMulL_rReg_rule: {
      overflowMulL_rRegNode *node = new (C) overflowMulL_rRegNode();
      return node;
    }
  case overflowMulL_rReg_imm_rule: {
      overflowMulL_rReg_immNode *node = new (C) overflowMulL_rReg_immNode();
      node->set_opnd_array(3, MachOperGenerator(RREGL, C));
      return node;
    }
  ...
  case compN_rReg_imm_klass_rule: {
      compN_rReg_imm_klassNode *node = new (C) compN_rReg_imm_klassNode();
      return node;
    }
  case compN_mem_imm_klass_rule: {
      compN_mem_imm_klassNode *node = new (C) compN_mem_imm_klassNode();
      return node;
    }
  case testN_reg_rule: {
  ...
  case cmpFastLockRTM_rule: {
      cmpFastLockRTMNode *node = new (C) cmpFastLockRTMNode();
      node->set_opnd_array(3, MachOperGenerator(RAX_REGI, C));
      node->set_opnd_array(4, MachOperGenerator(RDX_REGI, C));
      node->set_opnd_array(5, MachOperGenerator(RREGI, C));
